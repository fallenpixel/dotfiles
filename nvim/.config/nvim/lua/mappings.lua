...
map('n', '<leader>fm',   '<cmd>lua vim.lsp.buf.formatting()<CR>', default_options)
...
map("n", "<leader>ml",
  "<cmd>set ft=ansible.yaml ts=2 et<cr>ggO# vim:ft=ansible.yaml ts=2 et<esc><C-o>", default_options)
...
map('n', '<leader>hs', "<cmd>Gitsigns stage_hunk<cr>", default_options)
...
map('v', "<leader>hn", "<cmd>Gitsigns next_hunk<cr>", default_options)
map('v', "<leader>hp", "<cmd>Gitsigns prev_hunk<cr>", default_options)
map("n", "<leader>md", "<cmd>Glow<cr>", default_options)
